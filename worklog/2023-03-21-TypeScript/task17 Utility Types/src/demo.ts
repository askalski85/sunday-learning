...
// Partial defines all its members as optional
// type ContactQuery = Partial<Record<keyof Contact, Query>>

// Omit helper - eliminate certain properties
...
type ContactQuery =
    Partial<
        Pick<
            ...
            "id" | "name"  // no new fields will be added
        >
    >

// Required helper turns all members as required
type RequiredQuery = Required<ContactQuery>
